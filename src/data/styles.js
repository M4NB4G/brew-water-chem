...
export const STYLE_FAMILIES = [
  {
    ...
    profile: { Ca: 50, Mg: 10, Na: 5, SO4: 50, Cl: 50, Alk: 25, RA: -40 },
    so4_cl_target: 1.0,
  ...
  },
  {
    ...
    profile: { Ca: 60, Mg: 18, Na: 10, SO4: 30, Cl: 60, Alk: 25, RA: -40 },
    so4_cl_target: 0.5,
    page_ref: 'Palmer-Kaminski p. 156–157 Table 18',
  },
  {
    ...
    profile: { Ca: 75, Mg: 10, Na: 15, SO4: 75, Cl: 125, Alk: 100, RA: 10 },
    so4_cl_target: 0.6,
    page_ref: 'Palmer-Kaminski p. 156–157 Table 18',
  },
  {
    id: 'pale_ale',
    name: 'Kölsch / Blonde / Cream',
    bjcp: '1C, 5B, 18A',
    description: 'Soft balanced profile for these pale, subtle ales.',
    profile: { Ca: 75, Mg: 10, Na: 10, SO4: 75, Cl: 75, Alk: 25, RA: -40 },
    so4_cl_target: 1.0,
  ...
  },
  {
    ...
    profile: { Ca: 70, Mg: 15, Na: 35, SO4: 110, Cl: 55, Alk: 25, RA: -30 },
    so4_cl_target: 2.0,
  ...
  },
  {
    ...
    profile: { Ca: 120, Mg: 18, Na: 15, SO4: 225, Cl: 75, Alk: 40, RA: -15 },
    so4_cl_target: 3.0,
    page_ref: 'Palmer-Kaminski p. 158–159 Table 19',
  },
  {
    ...
    profile: { Ca: 100, Mg: 12, Na: 15, SO4: 100, Cl: 200, Alk: 25, RA: -40 },
    so4_cl_target: 0.5,
  ...
  },
  {
    ...
    profile: { Ca: 90, Mg: 15, Na: 25, SO4: 110, Cl: 90, Alk: 50, RA: 0 },
    so4_cl_target: 1.2,
    page_ref: 'Palmer-Kaminski p. 158–159 Table 19',
  },
  {
    ...
    profile: { Ca: 100, Mg: 20, Na: 50, SO4: 80, Cl: 100, Alk: 125, RA: 75 },
    so4_cl_target: 0.8,
  ...
  },
  {
    ...
    profile: { Ca: 100, Mg: 20, Na: 50, SO4: 75, Cl: 100, Alk: 125, RA: 90 },
    so4_cl_target: 0.75,
  ...
  },
  {
    ...
    profile: { Ca: 60, Mg: 10, Na: 10, SO4: 50, Cl: 60, Alk: 50, RA: -30 },
    so4_cl_target: 0.83,
    page_ref: 'Palmer-Kaminski p. 158–159 Table 19',
  },
  {
    ...
    profile: { Ca: 50, Mg: 10, Na: 10, SO4: 30, Cl: 50, Alk: 25, RA: -40 },
    so4_cl_target: 0.83,
    page_ref: 'Palmer-Kaminski p. 158–159 Table 19',
  },
];
